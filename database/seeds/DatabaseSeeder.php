...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        factory(User::class, 35)->create(['city_id' => $this->cityIds->shuffle()->first()])->each(function ($user) {
        ...
        factory(User::class, 100)->create(['city_id' => $this->cityIds->shuffle()->first()])->each(function ($user) {
            $this->seedForUser($user);
        });
    }
