...
window.gallery = __webpack_require__(43);
...
var RoomContainer = function RoomContainer(props) {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            { href: '#', onClick: function onClick() {
                    return props.selectRoom(props.room.id);
                } },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
    ...
    _createClass(RoomContents, [{
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: this.props.isTyping ? "is-writing" : "is-writing hide" },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'icon-feather-edit-2' }),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'span',
                        null,
                        this.props.room.otherUser.name,
...
var Chat = function (_Component2) {
    ...
    function Chat(props) {
        ...
        _this3.markAllMessagesAsRead = _this3.markAllMessagesAsRead.bind(_this3);
        return _this3;
    }
    ...
    _createClass(Chat, [{
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: 'messages-container-inner' },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: 'messages-inbox' },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'ul',
                        null,
        ...
        value: function listenForBroadcast(id) {
            ...
            var typingInterval = setTimeout(function () {
                return _this8.setState({ isTyping: false });
            }, 3000);

            this.markAllMessagesAsRead(id);

            Echo.join('room.' + id).listen('Chat.ChatMessageSent', function (e) {
                clearInterval(typingInterval);

                _this8.markAllMessagesAsRead(id);
        ...
        value: function markAllMessagesAsRead(id) {
...
if (document.getElementById('chat')) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Chat, props), component);
}
